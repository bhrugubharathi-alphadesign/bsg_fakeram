...
class Decoder : public Component
{
  public:
    ...
    int    num_gates_min;
    double w_dec_n[MAX_NUMBER_GATES_STAGE];    // Alireza: width of NMOS transistors in the decoder, DEMUX (if any), and WL (or WWL) driver
    double w_dec_p[MAX_NUMBER_GATES_STAGE];    // Alireza: width of PMOS transistors in the decoder, DEMUX (if any), and WL (or WWL) driver
    double w_dec_n_rd[MAX_NUMBER_GATES_STAGE]; // Alireza: width of NMOS transistors in the decoder, DEMUX, and RWL driver
