...
class TechnologyParameter
{
 public:
  ...
  {
   public:
    double b_w;           // Alireza: width of the SRAM cell
    double b_h;           // Alireza: height of the SRAM cell
    double cell_a_w;      // Alireza: width of (write) access transistors for 6T and 8T cells
    double cell_pmos_w;   // Alireza: width of pull-up (pmos) transistors for 6T and 8T cells
    double cell_nmos_w;   // Alireza: width of pull-down (nmos) transistors for 6T and 8T cells
    double cell_rd_a_w;   // Alireza: width of the read access transistor for 8T cell
    double cell_rd_iso_w; // Alireza: width of the storage/read isolator transistor for 8T cell
    double Vbitpre;       // Alireza: the voltage level that bitlines are precharged to
  ...
  double Vbit_sense_min; // minimum bitline sense voltage. -Alireza2
